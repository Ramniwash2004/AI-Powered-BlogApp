...
const Blog=()=>{
    ...
    return data ? (
        <div className="relative">
            <img src={assets.gradientBackground} alt="" className="absolute -top-50 -z-1 opacity-70" />
            <Navbar/>
            <div className="text-center mt-20 text-gray-600">
                <p className="text-primary py-4 font-medium">Published on {Moment(data.createdAt).format("MMMM Do YYYY")}</p>
                <h1 style={{fontSize:"3.5rem"}} className="text-5xl sm:text-5xl font-bold max-w-4xl mx-auto text-gray-800">{data.title}</h1>
            ...
            <div className="my-24 max-w-3xl mx-auto">
                ...
                <div className="flex">
                    <img src={assets.facebook_icon} width={70} alt=""/>
                    <img src={assets.twitter_icon} width={70} alt=""/>
                    <img src={assets.googleplus_icon} width={70} alt=""/>
                </div>
            </div>
            <Footer/>
        </div>
