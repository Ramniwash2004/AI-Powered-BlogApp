...
const AddBlog = () => {
    ...
    const { axios } = useAppContext();// only axios from context
    const [isAdding, setIsAdding] = useState(false);//local state
        ...
        <form onSubmit={onSubmitHandler} className="flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll">
            <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
                <p>Upload Thumbnail</p>
                    ...
                    <div className="max-w-3lg h-74 pb-16 sm:pb-10 pt-2 relative">
                    ...
                    <div className="mt-4">
                        <p className="inline font-bold">Publish Now</p>
                        <input type="checkbox" checked={isPublished} className="mx-4  scale-300 cursor-pointer" onChange={e=>setIsPublished(e.target.checked)} />
                    </div>
