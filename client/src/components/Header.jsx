    ...
    return(
        <div className="mx-8 sm:mx-16 xl:mx-24 relative">
            <div className="text-center mt-20 mb-8">
                ...
                <div className="inline-flex items-center justify-center gap-4 px-6
                ...
                <h1 style={{fontSize:"3.5rem"}} className="text-4xl sm:text-6xl font-bold sm:leading-20
                text-gray-900">Your Own <span style={{fontSize:"3.5rem"}} className="text-primary"> blogging</span> 
                <br/> Platform.</h1>

                <p className="my-6 sm:my-8 max-w-4xl m-auto max-sm:text-xs text-gray-500">
                    This is your space to think out loud ,to share what matters,and to write without filters.
                    Whether it's one word or a thousand ,your story satrts right here.</p>    
